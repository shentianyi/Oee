...
class MachinesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create machine" do
    assert_difference('Machine.count') do
      post machines_url, params: { machine: { department_id: @machine.department_id, machine_type_id: @machine.machine_type_id, nr: @machine.nr, oee_nr: @machine.oee_nr, remark: @machine.remark, status: @machine.status } }
    end
  ...
  test "should update machine" do
    patch machine_url(@machine), params: { machine: { department_id: @machine.department_id, machine_type_id: @machine.machine_type_id, nr: @machine.nr, oee_nr: @machine.oee_nr, remark: @machine.remark, status: @machine.status } }
