...
class HolidaysControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create holiday" do
    assert_difference('Holiday.count') do
      post holidays_url, params: { holiday: { holiday: @holiday.holiday, remark: @holiday.remark, type: @holiday.type } }
    end
  ...
  test "should update holiday" do
    patch holiday_url(@holiday), params: { holiday: { holiday: @holiday.holiday, remark: @holiday.remark, type: @holiday.type } }
