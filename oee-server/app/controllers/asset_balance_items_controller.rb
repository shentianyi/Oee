class AssetBalanceItemsController < ApplicationController
  ...
  private
    ...
    def asset_balance_item_params
      params.require(:asset_balance_item).permit(:fix_asset_track_id, :cap_date, :profit_center, :asset_description, :acquis_val, :accum_dep, :book_val, :asset_class, :inventory_nr, :ts_equipment_nr, :ts_project, :ts_inventory_user, :ts_keeper, :ts_position, :ts_nameplate_track, :ts_type, :ts_equipment_type, :ts_area, :ts_supplier, :status, :remark, :ts_inventory_result)
    end
end
