class InventoryItem < ApplicationRecord
  ...
  belongs_to :equipment_track, class_name: 'EquipmentTrack'
  ...
  def cover_item
    ...
    begin
      message = self.update_attributes({
                                           project: self.current_project,
                                           ts_area_id: self.current_area_id,
                                           status: self.current_status,
                                           nameplate_track: self.current_nameplate
                                       })
